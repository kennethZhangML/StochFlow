...
class BackwardFokkerPlanck(NumericalSolver):
    def __init__(self, equation, final_condition, time_step, num_steps):
        super().__init__(equation, final_condition, time_step, num_steps)
